...
my_doc <- read_docx('/Users/zhuomingx/Desktop/Rbio/tb_optimize/data/vector&vrius_templete.docx')
...
manual_list <- #dir('./data/manual','.pdf',full.names = T)%>%
        dir('/Users/zhuomingx/Desktop/Rbio/tb_optimize/data/manual','.pdf',full.names = T) %>% 
